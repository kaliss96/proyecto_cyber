...
<div class="col-md-3">
    ...
    <a href="<?php echo $URLSITE; ?>tipocargos/borrar" class="btn btn-info " style="width:100%;">Agregar tipo Servicios</a> 
...
<?php echo $this->Form->create('Tipocargo',array('action' => 'delete', 'id' => 'formulario', 'role' => 'form')); ?>
	
<div class="panel panel-primary">

      <div class="panel-heading">
        <h3 class="panel-title">Eliminar Tipo Servicio</h3>
      </div>
      <div class="panel-body">
		
			<label>Id de Tipo de Servicio</label>
