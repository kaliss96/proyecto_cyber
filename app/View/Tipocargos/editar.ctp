...
<div class="col-md-3">
    ...
    <a href="<?php echo $URLSITE; ?>tipocargos/editar" class="btn btn-info " style="width:100%;">Agregar tipo Servicios</a> 
...
<?php echo $this->Form->create('Tipocargo',array('action' => 'editar', 'id' => 'formulario', 'role' => 'form')); ?>
	
<div class="panel panel-primary">

      <div class="panel-heading">
        <h3 class="panel-title">Editar Tipo Cargo</h3>
      </div>
