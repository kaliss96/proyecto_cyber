...
<?php echo $this->Form->create('Usuario',array('action' => 'agregar', 'id' => 'formulario', 'role' => 'form')); ?>
...
<div class="panel panel-primary">
      ...
      <div class="panel-body">
			...
			<br/>
			<?php	echo $this->Form->end(array('label' => 'Guardar Usuario','class' =>  'btn btn-success')); ?>
