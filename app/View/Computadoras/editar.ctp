...
<?php echo $this->Form->create('Computadora',array('action' => 'editar', 'id' => 'formulario', 'role' => 'form')); ?>
	
<div class="panel panel-primary">

      <div class="panel-heading">
        <h3 class="panel-title">Editar Computadora</h3>
      </div>
      <div class="panel-body">
			...
			<br/>
			<?php	echo $this->Form->end(array('label' => 'Editar Computadora','class' =>  'btn btn-success')); ?>
