...
<div class="col-md-3">
    ...
    <a href="<?php echo $URLSITE; ?>cargos/editar" class="btn btn-info " style="width:100%;">Agregar Servicios</a> 
...
<?php echo $this->Form->create('Cargo',array('action' => 'delete', 'id' => 'formulario', 'role' => 'form')); ?>
	
<div class="panel panel-primary">

      <div class="panel-heading">
        <h3 class="panel-title">Eliminar Servicio</h3>
      </div>
